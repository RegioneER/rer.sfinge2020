...
class SceltaFirmatarioRispostaComunicazioneProgettoType extends \RichiesteBundle\Form\RichiestaType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'IstruttorieBundle\Entity\RispostaComunicazioneProgetto',
        ));
