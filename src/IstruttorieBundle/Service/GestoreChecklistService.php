...
class GestoreChecklistService {
	...
	public function getGestore(Procedura $procedura = null) {
		...
		$nomeClasse = "IstruttorieBundle\GestoriChecklist\GestoreChecklistBando_" . $id_bando;
		try {
		...
		return new GestoreChecklistBase($this->container);
	}
