...
/**
 * @ORM\Entity()
 * @ORM\Table(name="risposte_esiti_istruttorie_documenti")
 */
class RispostaEsitoIstruttoriaDocumento extends EntityLoggabileCancellabile
{
    /**
     * @ORM\Id
   ...
   /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="IstruttorieBundle\Entity\RispostaComunicazioneEsitoIstruttoria", inversedBy="documenti")
     * @ORM\JoinColumn(nullable=false)
     */
