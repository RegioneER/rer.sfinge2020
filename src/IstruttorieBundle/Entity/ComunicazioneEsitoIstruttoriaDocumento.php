...
/**
 * @ORM\Entity()
 * @ORM\Table(name="comunicazioni_esiti_istruttorie_documenti")
 */
class ComunicazioneEsitoIstruttoriaDocumento extends EntityLoggabileCancellabile
{
    /**
     * @ORM\Id
   ...
   /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="IstruttorieBundle\Entity\ComunicazioneEsitoIstruttoria", inversedBy="documenti_comunicazione")
     * @ORM\JoinColumn(nullable=false)
     */
