...
/**
 * @ORM\Entity()
 * @ORM\Table(name="risposte_comunicazioni_progetto_documenti")
 */
class RispostaComunicazioneProgettoDocumento extends EntityLoggabileCancellabile
{
    /**
     * @ORM\Id
   ...
   /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="IstruttorieBundle\Entity\RispostaComunicazioneProgetto", inversedBy="documenti")
     * @ORM\JoinColumn(nullable=false)
     */
