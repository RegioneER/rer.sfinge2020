...
/**
 * @ORM\Entity()
 * @ORM\Table(name="comunicazioni_attuazione_documenti")
 */
class ComunicazioneAttuazioneDocumento extends EntityLoggabileCancellabile
{
    /**
     * @ORM\Id
   ...
   /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AttuazioneControlloBundle\Entity\ComunicazioneAttuazione", inversedBy="documenti_comunicazione")
     * @ORM\JoinColumn(nullable=false)
     */
