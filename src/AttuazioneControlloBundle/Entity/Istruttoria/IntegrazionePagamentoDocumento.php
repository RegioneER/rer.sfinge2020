...
/**
 * @ORM\Entity()
 * @ORM\Table(name="integrazioni_documenti_pagamenti")
 */
class IntegrazionePagamentoDocumento extends EntityLoggabileCancellabile
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AttuazioneControlloBundle\Entity\Istruttoria\IntegrazionePagamento", inversedBy="tipologie_documenti")
     * @ORM\JoinColumn(nullable=false)
     */
