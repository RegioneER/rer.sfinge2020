...
/**
 * @ORM\Entity()
 * @ORM\Table(name="valutazioni_elementi_checklist_controlli")
 */
class ValutazioneElementoChecklistControllo {
	...
	/**
	 * @ORM\ManyToOne(targetEntity="AttuazioneControlloBundle\Entity\Controlli\ElementoChecklistControllo", inversedBy="valutazioni")
	 ...
	 * @ORM\Column(type="text", nullable=true)
	 */
	protected $collocazione_ben;
	
	/**
	 * @ORM\ManyToOne(targetEntity="AttuazioneControlloBundle\Entity\Controlli\ValutazioneChecklistControllo", inversedBy="valutazioni_elementi")
	 * @ORM\JoinColumn(nullable=false)
	 */
    ...
    public function getDocumentiText() {
        return $this->documenti_text;
    }
    ...
    public function setDocumentiText($documenti_text) {
        $this->documenti_text = $documenti_text;
    }
    ...
    public function getCollocazioneBen() {
        return $this->collocazione_ben;
    }

    public function setCollocazioneBen($collocazione_ben) {
        $this->collocazione_ben = $collocazione_ben;
    }
