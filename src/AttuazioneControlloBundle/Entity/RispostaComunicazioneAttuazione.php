...
/**
 * RispostaComunicazioneAttuazione
 *
 * @ORM\Table(name="risposte_comunicazioni_attuazione")
 * @ORM\Entity()
 */
class RispostaComunicazioneAttuazione extends EntityLoggabileCancellabile {
    ...
    /**
     * @ORM\OneToOne(targetEntity="AttuazioneControlloBundle\Entity\ComunicazioneAttuazione", inversedBy="risposta")
    ...
    /**
     * @ORM\OneToMany(targetEntity="ProtocollazioneBundle\Entity\RichiestaProtocolloRispostaComunicazioneAttuazione", mappedBy="risposta_comunicazione_attuazione", cascade={"persist"})
     */
    protected $richieste_protocollo;

    /**
     * @ORM\OneToMany(targetEntity="AttuazioneControlloBundle\Entity\RispostaComunicazioneAttuazioneDocumento", mappedBy="risposta_comunicazione", cascade={"persist"})
     */
    protected $documenti;
    ...
    public function getNomeClasse() {
        return "RispostaComunicazioneAttuazione";
    }
    ...
    public function getProtocolloRispostaComunicazione() {
        ...
        foreach ($this->richieste_protocollo as $r) {
            if ($r->getNomeClasse() == 'RichiestaProtocolloRispostaComunicazioneAttuazione') {
    ...
    public function isInviata() {
        return in_array($this->getStato()->getCodice(), array('COM_INVIATA_PA','COM_PROTOCOLLATA'));
    }
}
