...
class GestoreComunicazioneAttuazioneService
{
    protected $container;
    ...
    public function getGestore($bundle = null){
        ...
        $nomeClasse .= "\GestoriComunicazione\GestoreComunicazioneAttuazione";
        ...
        return new GestoreComunicazioneAttuazioneBase($this->container);
    }
}