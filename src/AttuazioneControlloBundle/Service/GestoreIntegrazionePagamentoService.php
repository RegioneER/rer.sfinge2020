...
class GestoreIntegrazionePagamentoService
{
    protected $container;
    ...
    public function getGestore($bundle = null){
        ...
        $nomeClasse .= "\GestoriIntegrazionePagamento\GestoreIntegrazionePagamento";
        ...
        return new GestoreIntegrazionePagamentoBase($this->container);
    }
}