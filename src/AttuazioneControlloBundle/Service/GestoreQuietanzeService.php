...
class GestoreQuietanzeService
{
    protected $container;
	
    /**
     * GestoreQuietanzeService constructor.
     */
    ...
    public function getGestore(Procedura $procedura = null){
        ...
        $nomeClasse = "AttuazioneControlloBundle\GestoriQuietanze\GestoreQuietanzeBando_".$id_procedura;
        try{
        ...
        return new GestoreQuietanzeBase($this->container);
    }
}