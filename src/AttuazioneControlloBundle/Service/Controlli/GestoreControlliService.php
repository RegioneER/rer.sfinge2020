...
class GestoreControlliService
{
    ...
    public function getGestore(Procedura $procedura = null){
        ...
        $nomeClasse = "AttuazioneControlloBundle\GestoriControlli\GestoreControlliBando_".$id_procedura;
        try{
        ...
        return new GestoreControlliBase($this->container);
    }
}