...
class GestoreProrogheService
{
    ...
    public function getGestore(Procedura $procedura = null){
        ...
        $nomeClasse = "AttuazioneControlloBundle\GestoriPagamenti\GestoreProrogheBando_".$id_procedura;
        try{
        ...
        return new GestoreProrogheBase($this->container);
    }
}