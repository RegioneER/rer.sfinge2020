...
class PrincipiRsiImpreseDiServizi
{
    /**
    ...
    public function validaSceltaInnovazioneSostenibile(IstanzaPagina $istanzaPagina): ConstraintViolationList
    {
        ...
        $campo = $this->fascicoloService->getOne($istanzaFascicolo, 'principi_rsi_imprese_di_servizi.indice_rsi.principi_rsi_sezione_8.principi_rsi_sotto_pagina_8_1.campo_8_1_1', true);
        ...
        $campo_scelta = $this->container->get("fascicolo.istanza")->getOne($istanzaPagina->getIstanzaFascicolo(), "principi_rsi_imprese_di_servizi.indice_rsi.principi_rsi_sezione_8.principi_rsi_sotto_pagina_8_1.campo_8_1_1", true);
        $campo_altro = $this->container->get("fascicolo.istanza")->get($istanzaPagina->getIstanzaFascicolo(), "principi_rsi_imprese_di_servizi.indice_rsi.principi_rsi_sezione_8.principi_rsi_sotto_pagina_8_1.campo_8_1_2");
