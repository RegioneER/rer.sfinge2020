...
/**
 * @Route("/assistenza_tecnica/pagamenti")
 */
class PagamentiAssTecnicaController extends \BaseBundle\Controller\BaseController {

	/**
	 * @Route("/{id_richiesta}/elenco_pagamenti", name="elenco_pagamenti_at")
	 ...
	 * 						 @ElementoBreadcrumb(testo="Dettaglio richiesta", route="dettaglio_richiesta_at", parametri={"id_richiesta" = "id_richiesta"}),
	...
	/**
	 * @Route("/{id_richiesta}/riepilogo", name="riepilogo_richiesta_attuazione_at")
	...
	/**
	 * @Route("/{id_richiesta}/aggiungi", name="aggiungi_pagamento_at")
	 * @PaginaInfo(titolo="Creazione richiesta pagamento",sottoTitolo="pagina di creazione di un pagamento")
	 * @Menuitem(menuAttivo = "elencoRichiesteAt")
	 * @Breadcrumb(elementi={@ElementoBreadcrumb(testo="Elenco progetti", route="elenco_richieste_at"),
	 * 						 @ElementoBreadcrumb(testo="Dettaglio richiesta", route="dettaglio_richiesta_at", parametri={"id_richiesta" = "id_richiesta"}),
	 * 						 @ElementoBreadcrumb(testo="Elenco pagamenti richiesti", route="elenco_pagamenti_at", parametri={"id_richiesta" = "id_richiesta"}),
	...
	/**
	 * @Route("/{id_pagamento}/elimina", name="elimina_pagamento_at")
	 */
	...
	/**
	 * @Route("/{id_pagamento}/dettaglio", name="dettaglio_pagamento_at")
	...
	/**
	 * @Route("/{id_pagamento}/dati_generali", name="dati_generali_pagamento_at")
	...
	/**
	 * @Route("/{id_pagamento}/mandato", name="mandato_pagamento_at")
	...
	/**
	 * @Route("/valuta/{id_pagamento}", name="valuta_checklist_istruttoria_pagamenti_at")
	 * @Menuitem(menuAttivo = "elencoRichiesteAt")
	 */
	...
	/**
	 *
	 * @Route("/{id_pagamento}/completa_pagamento", name="completa_pagamento_at")
	 * @Method({"GET"})
	 * @Menuitem(menuAttivo = "elencoRichiesteAt")
	 */
	...
	/**
	 * 
	 * @Route("/{id_richiesta}/elenco_documenti_caricati_pag_at/{id_pagamento}", name="elenco_documenti_caricati_pag_at")
	 * @Method({"GET","POST"})
	 * @Breadcrumb(elementi={@ElementoBreadcrumb(testo="Elenco progetti", route="elenco_richieste_at"),
	 * 						 @ElementoBreadcrumb(testo="Dettaglio richiesta", route="dettaglio_richiesta_at", parametri={"id_richiesta" = "id_richiesta"}),
	...
	/**
	 * @Route("/{id_documento_pagamento}/elimina_documento_pagamento_at", name="elimina_documento_pagamento_at") 
	 */
