...
class Indicatore_RCO01d extends ACalcoloIndicatore {
    ...
    public function getValore(): float {
        ...
        $precedente = new Indicatore_RCO01c($this->container, $richiesta);
...
//            $fatturato = $this->fatturatoGrande($fatturatoAnno1, $fatturatoAnno2);
//            $dipendenti = $this->dipendentiGrande($numeroDipendentiAnno1, $numeroDipendentiAnno2);
//            $patrimoniale = $this->patrimonialeGrande($statoPatrimonialeAnno1, $statoPatrimonialeAnno2);
//
...
//            }
    ...
    public function verificaAnno1($fatturatoAnno1, $numeroDipendentiAnno1, $statoPatrimonialeAnno1) {
        return $numeroDipendentiAnno1 >= 250 && ($fatturatoAnno1 > 50000000 || $statoPatrimonialeAnno1 > 43000000);
    }

    public function verificaAnno2($fatturatoAnno2, $numeroDipendentiAnno2, $statoPatrimonialeAnno2) {
        return $numeroDipendentiAnno2 >= 250 && ($fatturatoAnno2 > 50000000 || $statoPatrimonialeAnno2 > 43000000);
    }

    public function fatturatoGrande($fatturatoAnno1, $fatturatoAnno2) {
        return ($fatturatoAnno1 > 50000000 ) || ($fatturatoAnno2 > 50000000 );
    }

    public function dipendentiGrande($numeroDipendentiAnno1, $numeroDipendentiAnno2) {
        return ($numeroDipendentiAnno1 >= 250) || ($numeroDipendentiAnno2 >= 250);
    }

    public function patrimonialeGrande($statoPatrimonialeAnno1, $statoPatrimonialeAnno2) {
