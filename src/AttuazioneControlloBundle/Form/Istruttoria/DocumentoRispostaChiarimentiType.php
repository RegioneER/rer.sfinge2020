...
class DocumentoRispostaChiarimentiType extends CommonType {
    ...
    public function configureOptions(OptionsResolver $resolver) {
        $resolver->setDefaults([
            'data_class' => DocumentoRispostaRichiestaChiarimenti::class,
            "constraints" => [
                new Callback(function (DocumentoRispostaRichiestaChiarimenti $documentoPagamento, ExecutionContextInterface $context) {
                        ...
                        $validator = new \Gdbnet\FatturaElettronica\XmlValidator();
