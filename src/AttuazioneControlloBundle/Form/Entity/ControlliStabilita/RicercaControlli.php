...
namespace AttuazioneControlloBundle\Form\Entity\ControlliStabilita;
...
class RicercaControlli extends AttributiRicerca {
    ...
    public function getType() {
        return "AttuazioneControlloBundle\Form\ControlliStabilita\RicercaControlliType";
    }

    public function getNomeRepository() {
        return "AttuazioneControlloBundle:Controlli\ControlloCampione";
    }

    public function getNomeMetodoRepository() {
        return "getCampioniByDateRicerca";
    }
    ...
    function setCampione($campione): void {
