...
class GestoreFaseProceduraleService {
	...
	public function getGestore(Procedura $procedura = null) {
		...
		$nomeClasse = "RichiesteBundle\GestoriFasiProcedurali\GestoreFaseProceduraleBando_" . $id_bando;
		try {
		...
		return new GestoreFaseProceduraleBase($this->container);
	}
