...
class GestoreAmbitiTematiciS3Service
{
    /**
     ...
     * @return GestoreAmbitiTematiciS3Base|string
     * @throws Exception
     */
	public function getGestore(Procedura $procedura = null)
    {
		...
		$nomeClasse = "RichiesteBundle\GestoreAmbitiTematici\GestoreAmbitiTematiciS3_" . $id_bando;
		try {
		...
		return new GestoreAmbitiTematiciS3Base($this->container);
	}
}
