 ...
 */
class AziendaConsultazioneSedeController extends Controller {
	
	/**
	 * @Route("/elenco/{id_soggetto}", name="elenco_sedi_operative")
	 * @Breadcrumb(elementi={@ElementoBreadcrumb(testo="Elenco sedi")})
	 * @PaginaInfo(titolo="Azienda - Elenco sedi")
	...
	/**
	 * @Route("/visualizza/{id_soggetto}/{id_sede}", name="azienda_visualizza_sede_operativa")
