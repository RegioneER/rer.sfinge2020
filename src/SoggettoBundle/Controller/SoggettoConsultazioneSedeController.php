 ...
 */
class SoggettoConsultazioneSedeController extends Controller {
	
	/**
	 * @Route("/elenco/{id_soggetto}", name="elenco_sedi_operative_soggetto")
	 * @Breadcrumb(elementi={@ElementoBreadcrumb(testo="Elenco sedi")})
	 * @PaginaInfo(titolo="Soggetto - Elenco sedi")
	...
	/**
	 * @Route("/visualizza/{id_soggetto}/{id_sede}", name="soggetto_visualizza_sede_operativa")
	 * @Template("SoggettoBundle:Sede:sede.html.twig")
	 * @Breadcrumb(elementi={@ElementoBreadcrumb(testo="Gestione sedi", route="elenco_sedi_operative_soggetto",parametri={"id_soggetto"}), @ElementoBreadcrumb(testo="Visualizza sede")})
	 * @PaginaInfo(titolo="Soggetto - Visualizza sede")
	 * @ControlloAccesso(contesto="soggetto", classe="SoggettoBundle:Soggetto", opzioni={"id" = "id_soggetto"}, azione="show")
	 */
	public function visualizzaSedeOperativaAction(Request $request, $id_soggetto, $id_sede) {
		...
		//controllo se sede a aziende sono coerenti 
		...
		$options["url_indietro"] = $this->generateUrl("elenco_sedi_operative_soggetto",array("id_soggetto"=>$id_soggetto));
