...
class MonitoraggioConfigurazioneEsportazioneTrasferimentoType extends CommonType
{
    /**
     * {@inheritdoc}
     */
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setDefaults(array(
            'data_class' => 'MonitoraggioBundle\Entity\MonitoraggioConfigurazioneEsportazioneTrasferimento',
        ));
    }
