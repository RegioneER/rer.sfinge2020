...
VALUES (@checklist_1_id, @fase_1_id,'checklist_formale_2_cultura','Verifica formale','ROLE_ISTRUTTORE',1,0);
...
INSERT INTO `istruttorie_checklist` (`id`,`fase_id`,`codice`,`nome`,`ruolo`,`molteplicita`,`proponente`) 
VALUES (@checklist_2_id, @fase_2_id,'checklist_sostanziale_2_cultura','Valutazione sostanziale','ROLE_VALUTATORE',1,0);
...
INSERT INTO `istruttorie_checklist` (`id`,`fase_id`,`codice`,`nome`,`ruolo`,`molteplicita`,`proponente`) 
VALUES (@checklist_3_id, @fase_3_id,'griglia_2_cultura','Valutazione','ROLE_VALUTATORE',1,0);
...
VALUES
	...
	(@sezione_checklist_1_id, '"(In caso di domanda presentata da società di capitali a prevalente capitale pubblico) Documentazione comprovante la procedura  
		di selezione del socio privato e  contestuale affidamento dell\'avvio, esecuzione e/o gestione del progetto candidato a finanziamento oppure lo Statuto 
		o l\'accordo da cui si evince che i soci privati, non beneficiano, direttamente o indirettamente, dei proventi derivanti dalla gestione economica 
		del progetto candidato a finanziamento né siano coinvolti nella sua realizzazione"', NULL, 'choice', 'a:3:{i:0;s:2:\"Si\";i:1;s:2:\"No\";i:2;s:3:\"N/P\";}', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL),
	...
	(@sezione_checklist_1_id, 'Costo complessivo non inferiore a 1 milione di euro', NULL, 'choice', 'a:3:{i:0;s:2:\"Si\";i:1;s:2:\"No\";i:2;s:3:\"N/P\";}', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL),
	...
	(@sezione_checklist_2_id, 'Coerenza con strategia, contenuti e obiettivi del POR', NULL, 'choice', 'a:2:{i:0;s:2:\"Si\";i:1;s:2:\"No\";}', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL),
	(@sezione_checklist_2_id, 'Coerenza con le politiche regionali di settore', NULL, 'choice', 'a:2:{i:0;s:2:\"Si\";i:1;s:2:\"No\";}', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL),
	(@sezione_checklist_2_id, 'Costo complessivo dell’investimento infrastrutturale non superiore a 5 milioni di euro o 10 milioni di euro nel caso di infrastrutture considerate patrimonio culturale mondiale UNESCO', NULL, 'choice', 'a:2:{i:0;s:2:\"Si\";i:1;s:2:\"No\";}', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL),
	(@sezione_checklist_2_id, 'Collocazione degli attrattori del patrimonio naturale nelle Città d\'Arte, nelle aree del sisma del 2012, e del Distretto turistico della Costa; in caso di progetto integrato la valutazione è riferita per ciascun soggetto associato', NULL, 'choice', 'a:2:{i:0;s:2:\"Si\";i:1;s:2:\"No\";}', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL),
	...
	(@sezione_checklist_3_id, 'A.6 Destinazione d’uso del bene oggetto d\'intervento; in caso di progetto integrato il punteggio assegnato deriva dalla MEDIA delle valutazioni degli interventi dei singoli soggetti associati (MAX 5)', NULL, 'integer', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL),
