...
UNION
SELECT  CONCAT('DELETE FROM fascicoli_procedure WHERE id IN (', @fascicoli_procedure_id, ');')
UNION
SELECT  CONCAT('UPDATE oggetti_richiesta SET istanza_fascicolo_id = NULL WHERE istanza_fascicolo_id IN (', @fascicoli_istanze_fascicoli_id, ');')
UNION
